    ...
    <div className="mx-auto max-w-4xl px-6 py-12 lg:px-8 space-y-10 text-zinc-300">
      ...
      <div className="space-y-8 text-xs leading-relaxed">
        <section className="space-y-3">
          ...
          <p>
            By licensing, installing, accessing, or using the Produce POS software application (the "Software"), hardware peripherals, or cloud services provided by Produce POS Inc. ("Company", "we", "us", or "our"), you ("Client", "Licensee", or "User") agree to be bound by these Terms and Conditions.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            Subject to payment of applicable subscription or hardware licensing fees, Produce POS grants Client a non-exclusive, non-transferable, revocable license to execute the Produce POS application across authorized store registers and backoffice terminals.
          </p>
        ...
        <section className="space-y-3">
          ...
          <p>
            Produce POS provides multi-tender checkout capabilities, including Cash, Credit Card, Debit Card, EBT SNAP Food Stamps, state WIC benefits, and OTC benefit cards. Client is solely responsible for maintaining valid merchant processing accounts, EBT SNAP merchant authorizations, and compliance with state WIC department rules.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            If you have questions regarding these Terms & Conditions, please email us at <span className="text-[#4ade80]">legal@producepos.com</span> or write to Produce POS Inc., New York, NY 10001, USA.
          </p>
        </section>
      </div>
    </div>
